...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2021 at 05:09 AM
...
--
-- Table structure for table `restaurant1811500036`
--

CREATE TABLE `restaurant1811500036` (
  `id` int(8) NOT NULL,
  `nama` varchar(50) NOT NULL,
  `latitude` double NOT NULL,
  `longitude` double NOT NULL
...
--
-- Dumping data for table `restaurant1811500036`
--

INSERT INTO `restaurant1811500036` (`id`, `nama`, `latitude`, `longitude`) VALUES
...
INSERT INTO `sekolah1811500036` (`id`, `Nama`, `latitude`, `longitude`) VALUES
...
--
-- Indexes for table `restaurant1811500036`
--
ALTER TABLE `restaurant1811500036`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `restaurant1811500036`
--
ALTER TABLE `restaurant1811500036`
